...
This is a list of resources that I used or was inspired by when developing the course as well as resources that I use in my day-to-day work. The list does not claim to be a good representation of all Ruby resources out there so make sure to search around.
